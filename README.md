...
C полным перечнем вы можете ознакомиться в полном перечнем функций: "[Полный перечень функций](docs/Полный_перечень_функций.md)"
...
Подробная документация по работе с TelegramMaster находится в разделе docs 📜, а так же реализован запуск документации непосредственно из программы.
