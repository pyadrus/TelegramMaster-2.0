...
2. В настройках программы пропишите время через сколько минут будет отправляться сообщения в группу.
3. Сформируйте список чатов, в которые будут рассылаться сообщения в пункте меню <b>"Рассылка сообщений"</b>
