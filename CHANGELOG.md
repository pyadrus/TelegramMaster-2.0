...
🔄 Обновление TelegramMaster 2.0 🚀<br>
Версия программы: ______<br>
Дата обновления: _______<br>

✨ Основные изменения и улучшения в проекте:

1. Структурирование проекта, для более быстрой и качественно разработки.
2. Удаленны зависимости от библиотек, которые не используются в проекте, для чистоты кода проекта.
3. Рефакторинг кода. Удаление не используемого кода и дублирующего кода программы.
4. Добавлена проверка на записанную группу для инвайтинга в настройках.
5. Добавлен выбор группы из выпадающего списка, для последующего инвайтинга.
6. Отображение настроек инвайтинга настроенных пользователем инвайтинга.
7. Добавлена возможность записывать в базу данных несколько ссылок для инвайтинга, так как в программе появился выбор
   группы для инвайтинга.
8. Обновление документации для функции "🚀 Инвайтинг"
9. Обновление документации для функции "⏰ Инвайтинг 1 раз в час"
10. Обновление документации для функции "🕒 Инвайтинг в определенное время"
11. Обновление документации для функции "📅 Инвайтинг каждый день"
