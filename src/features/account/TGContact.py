...
class TGContact:
    ...
    async def parsing_and_recording_contacts_in_the_database(self, client, list_view, page) -> None:
        """
    ...
    async def we_get_the_account_id(self, client, list_view, page) -> None:
        """
