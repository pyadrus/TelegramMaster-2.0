...
# Настройки меню
choice_of_reactions: str = "👍 Выбор реакций"
...
message_recording: str = "✉️ Запись сообщений"
link_entry: str = "🔗 Запись ссылки для инвайтинга"
account_limits: str = "📊 Лимиты на аккаунт"
message_limits: str = "📨 Лимиты на сообщения"
time_between_subscriptionss: str = "⏳ Время между подпиской"
creating_username_list: str = "📋 Формирование списка username"
recording_the_time_between_messages: str = "⏱️ Запись времени между сообщениями"
time_between_invites_sending_messages: str = "🕒 Время между инвайтингом, рассылка сообщений"
recording_reaction_link: str = "🔗 Запись ссылки для реакций"
forming_list_of_chats_channels: str = "📑 Формирование списка чатов / каналов"
...
changing_the_description: str = "✏️ Изменение описания"
name_change_n: str = "📝 Изменение имени"
name_change_f: str = "📝 Изменение фамилии"

# Меню работа с контактами
creating_a_contact_list: str = "📋 Формирование списка контактов"
show_a_list_of_contacts: str = "👥 Показать список контактов"
deleting_contacts: str = "🗑️ Удаление контактов"
adding_contacts: str = "➕ Добавление контактов"

# Меню подписка и отписка
subscription: str = "🔔 Подписка"
unsubscribe: str = "🚫 Отписываемся"

# Меню проверки аккаунтов
checking_through_a_spam_bot: str = "🤖 Проверка через спам бот"
validation_check: str = "✅ Проверка на валидность"
renaming_accounts: str = "✏️ Переименование аккаунтов"
full_verification: str = "🔍 Полная проверка"

# Меню подключения аккаунтов
connecting_accounts_by_phone_number: str = "📞 Подключение аккаунтов по номеру телефона"
