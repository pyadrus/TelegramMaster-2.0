...
1. Добавить функцию выбора аккаунта для определенных действий, что бы упростить новичкам работу с аккаунтами
2. Добавить определение страны по номеру телефона аккаунта
3. Добавить функцию, если ошибка аккаунта, то сообщить пользователю, что ошибка с аккаунтом и ему нужно проверить
   аккаунты на наличие ошибок
4. Создать HTML файл с понятиями и определениями
5. Добавить отображение результатов проверки аккаунтов. Такие, как: аккаунтов в бане 5 штук, не валидных аккаунтов 5
   штук, в папке инвайтинг валидных аккаунтов 1 штука
6. Добавить авторизацию по qr код.
7. Реализовать импорт списка из базы данных и загрузка списка в базу данных
8. Добавить восстановление файла config
9. Продумать настройки для каждой функции, что бы упростить работу новичков в работе с TelegramMaster 2.0
   ~~10. Просмотреть удаление username после рассылки сообщений.~~
10. Добавить в документацию информацию про уведомления, про то, что если в папке нет аккаунта, то выводить уведомление
    пользователю.
11. В документации структуру папок с аккаунтами сделать в виде таблицы.
12. Добавить в документацию название программы TelegramMaster 2.0, для большего и лучшего понимания пользователю, что проект именно TelegramMaster 2.0, а не старая версия программы.
...
2. Добавлено уведомление о наличии аккаунта для изменения био аккаунта в папке bio, если аккаунта нет, то TelegramMaster
   2.0
   выводит сообщение о том, что нужно подключить аккаунт.
3. Добавлено уведомление о наличии аккаунта для подписки в папке subscription, если аккаунта нет, то TelegramMaster 2.0
   выводит сообщение о том, что нужно подключить аккаунт.
...
13. Значительный рефакторинг кода, что дало дольше стабильности для работы программы.
