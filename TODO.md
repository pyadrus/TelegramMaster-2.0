...
9. Добавить в документацию информацию о том, что если в папке нет аккаунта, то выводить уведомление пользователю.
10. В документации структуру папок с аккаунтами сделать в виде таблицы.
11. Добавить в документацию название программы TelegramMaster 2.0 для лучшего понимания пользователями, что проект
    именно TelegramMaster 2.0, а не старая версия программы.
12. Добавить во все функции программы сообщения в терминал о начале и завершении работы.
13. В документации добавить кнопку "вверх".
14. Просмотреть возможность удаления username после рассылки сообщений.
15. Добавить автоответчик для рассылки сообщений.
16. Добавить функцию выбора аккаунта для определённых действий, чтобы упростить работу новичкам.
17. Добавить функцию жалобы на группы или каналы.
18. Добавить в программу выбор времени пользователем с помощью Flet, а не методом ввода данных.
19. Перенести наименование проекта в одну переменную.
