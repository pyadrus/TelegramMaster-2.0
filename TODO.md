...
11. Сделать кнопки по ширине и высоте одинакового размера.
...
5. Добавлен выпадающий список для парсинга.
6. Обновлена документация для Парсинга.
7. Во время парсинга отображается информация в GUI TelegramMaster 2.0.
