...
3. Проработано более 20 найденных или наиболее встречаемых ошибок, вызванными пользователем или со стороны Telegram, а также не устраненные с 1 версии TelegramMaster.
4. Частичный перенос локализации в отдельный файл, для лучшего контроля за наименованиями функций в документации и программе, а так же для дальнейшего перевода на другие языки, помимо русского языка. 
