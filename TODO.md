...
10. Просмотреть удаление username после рассылки сообщений.
    ~~11. Добавить уведомление во все функции, о том, что в папке нет аккаунта.~~
12. Добавить в документацию информацию про уведомления, про то, что если в папке нет аккаунта, то выводить уведомление
    пользователю.

🔄 Обновление TelegramMaster 2.0 🚀
Версия программы: _________
Дата обновления: __________
