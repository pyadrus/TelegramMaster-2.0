...
2. Для удобства пользователя в документацию было добавлено по функциям подменю в виде карточек.
3. Оптимизация кода, для большей стабильности TelegramMaster 2.0.
4. Для лучшей ориентации по функциям программы, были добавлены эмоджи на кнопки.
5. Добавлен выпадающий список для парсинга групп, на которые подписан аккаунт.
6. Обновлена документация для Парсинга.
7. Обновление документации для Настроек.
8. Обновление документации для Работы с реакциями
9. Обновление документации для Рассылки сообщений
10. Во время парсинга отображается информация в GUI TelegramMaster 2.0.
11. Улучшено логирование TelegramMaster 2.0
