...
11. Дополнена документация в разделах: "Работа с контактами", "Редактирование BIO", "Подключение аккаунтов", "🔄
    Подписка, отписка", а именно дополнительными скриншотами, дополнительным описанием, наименование приведены в
    соответствие, с наименованиями в программе, благодаря переходу к локализации проекта.
