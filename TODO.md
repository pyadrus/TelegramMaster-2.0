...
1. Проработан код для инвайтинга. Устранены наиболее часто встречаемые ошибки со стороны Telegram.
2. Добавлено определение страны по ip для proxy, с целью большего контроля за программой.
3. Проработано более 20 найденных или наиболее встречаемых ошибок, вызванными пользователем или со стороны Telegram, а
   также не устраненные с 1 версии TelegramMaster.
4. Частичный перенос локализации в отдельный файл, для лучшего контроля за наименованиями функций в документации и
   программе, а так же для дальнейшего перевода на другие языки, помимо русского языка.
5. Добавлена функция вывода информации пользователю об ошибки аккаунта и нужна проверка на ошибки.
6. Добавлено определение страны и оператора по номеру аккаунта. В дальнейшем, данная функция будет расширена.
7. Миграция документации с Flask на FastApi, для предотвращения конфликта библиотек.
8. Дополнена документация по работе функцией "👥 Создание групп (чатов)"
9. Информация выводимая программой помимо терминала, теперь выводится и в GUI программы, а именно при работе функции "👥
   Создание групп (чатов)"
10. Добавлено отображение информации в GUI программы, а именно при работе функции "Инвайтинг"
11. Дополнена документация в разделах: "Работа с контактами", "Редактирование BIO", "Подключение аккаунтов", "🔄
    Подписка, отписка", "🔐 Подключение аккаунтов", а именно дополнительными скриншотами, дополнительным описанием,
    наименование приведены в соответствие, с наименованиями в программе, благодаря переходу к локализации проекта.
12. Добавлено уведомление, об успешном вводе пользователем данных в "Настройках программы".
13. Значительно проработана функция "Парсинг активных пользователей".
14. В настройках проработана работа с настройками, добавлен вывод сообщения об успешном выполнении + проработаны редкие
    ошибки которые были вызванными пользователями программы.
15. Для лучшей ориентации по документации программы, а именно по разделу "⚙️ Настройки", раздел был разделен на подменю,
    благодаря ранее внедренному механизму, меню в виде карточек.
16. Добавлен вывод об успешном выполнении проверки аккаунтов через спам бот.
