...
4. Добавить отображение результатов проверки аккаунтов. Такие, как: аккаунтов в бане 5 штук, не валидных аккаунтов 5
   штук, в папке инвайтинг валидных аккаунтов 1 штука
5. Добавить авторизацию по qr код.
6. Реализовать импорт списка из базы данных и загрузка списка в базу данных
7. Добавить восстановление файла config
8. Продумать настройки для каждой функции, что бы упростить работу новичков в работе с TelegramMaster 2.0
9. Добавить в документацию информацию про уведомления, про то, что если в папке нет аккаунта, то выводить уведомление
   пользователю.
10. В документации структуру папок с аккаунтами сделать в виде таблицы.
11. Добавить в документацию название программы TelegramMaster 2.0, для большего и лучшего понимания пользователю, что
