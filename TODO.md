...
12. Добавить в документацию название программы TelegramMaster 2.0, для большего и лучшего понимания пользователю, что
    проект именно TelegramMaster 2.0, а не старая версия программы.
