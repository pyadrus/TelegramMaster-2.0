...
Иногда может потребоваться получение **api_id, api_hash (на данный момент api_id, api_hash уже прописаны в программу)**. Получить их можно на сайте [https://my.telegram.org/](https://my.telegram.org/)
